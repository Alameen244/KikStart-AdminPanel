      ...
      <InfoCard elevation={0}>
        ...
        <ContentBlock>
          <Typography variant="h5" sx={{ fontWeight: 700, color: "dark.main" }}>
            This section is managed by Why Us page
          </Typography>
          <Typography
            variant="body1"
          ...
          >
            Home page only shows a limited number of active Why Us cards based on
            <strong> homeLimit</strong>. Manage the full Why Us section, ordering,
            status, and section settings from the dedicated Why Us page.
          </Typography>
        </ContentBlock>
        ...
        <ButtonRow>
          <GoButton
            ...
            onClick={() => navigate("/content/why-us")}
          >
            Go To Why Us Page
          </GoButton>
        </ButtonRow>
